<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barberupdateprofile.aspx.cs" Inherits="barberapplication.barberupdateprofile" %>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-info">
    <a class="navbar-brand" href="barberdashboardd.aspx">Barber Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav  mr-auto">
        <li class="nav-item  ">
          ...
          <a class="nav-link " href="barberdashboardd.aspx"><i class="fa fa-home m-1"></i>Home </a>
        </li>
        <li class="nav-item active">
          <a class="nav-link " href="barberupdateprofile.aspx"><i  class="fa fa-user m-1"></i> Profile </a>
        </li>
            ...
            <div class="row">
              ...
              <div class="col-md-12"> 
                <div class="form-group">
                    ...
                    <asp:Label ID="Label2" runat="server" Text="Label"> Enter Barber Name</asp:Label>
