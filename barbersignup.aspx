<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="barbersignup.aspx.cs" Inherits="barberapplication.barbersignup" %>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Label"> Enter Barber Name</asp:Label>
