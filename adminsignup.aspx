<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsignup.aspx.cs" Inherits="barberapplication.adminsignup" %>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server" Text="Label"> Enter Admin Name</asp:Label>
              ...
              <div class="col-md-12">
                <div class="form-group">
                   <asp:Label ID="Label7" runat="server" Text="Label"> Address/Location</asp:Label>
                        <asp:TextBox ID="TextBox7" runat="server" class="form-control" Height="120px" required Width="100%" TextMode="MultiLine" ></asp:TextBox>
