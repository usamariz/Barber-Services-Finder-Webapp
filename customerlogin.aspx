<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerlogin.aspx.cs" Inherits="barberapplication.customerlogin" %>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav  mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link text-warning" href="barberlogin.aspx">Barber </a>
        </li>

        <li class="nav-item  active">
          <a class="nav-link" href="customerlogin.aspx">Customer</a>
        </li>
